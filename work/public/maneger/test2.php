...
foreach (array_map(null,$_POST['date'], $_POST['set_value'], $_POST['set_stock']) as [$date, $value, $stock]){

if(!empty($date) && $stock != '' && $value != ''){
...
echo $test5 = "SELECT * FROM $select WHERE day = :date ORDER BY reserve_date DESC";
echo '<br>';
echo $test5 = substr_replace($test5, "AND type = 1 ", 33, 0);
