...
<section>
  <?php if(!empty($_SESSION['cus_confirm'])): ?>
    <div id="leave-done" class="wrapper">
      <p class="done-text">退会手続きが完了しました。</p>
      <a href="https://ro-crea.com/demo_hotel/login" class="back">戻る</a>
    </div>
    <?php unset($_SESSION['cus_id']) ?>
    <?php unset($_SESSION['cus_login']) ?>
    <?php unset($_SESSION['cus_confirm']) ?>
